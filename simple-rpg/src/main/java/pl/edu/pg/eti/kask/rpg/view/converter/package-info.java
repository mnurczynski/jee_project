/**
 * JSF converters are objects which are used during JSF conversion phase when plain text value assigned to control
 ...
 */
package pl.edu.pg.eti.kask.rpg.view.converter;
